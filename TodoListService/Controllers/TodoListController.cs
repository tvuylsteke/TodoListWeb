...
namespace TodoListService.Controllers
{
    ...
    public class TodoListController : ApiController
    {
        ...
        public IEnumerable<TodoItem> Get()
        {
            ...
            //does not work
            //AD FS does not send user_impersonation (even if you have checked it)
            //if you flow it manually there's multiple values in the scope claim and this check fails as well.
